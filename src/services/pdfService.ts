// src/services/pdfService.ts - PROFESSIONAL ACADEMIC VERSION (Updated: Fixed Disclaimer Page)
// Quick Update: Removed black canvas, added signature on same page, fixed layout
        ...
        stack: [
          ...
          },
          {
            text: [
              ...
              { text: 'Pustakam Injin\n', fontSize: 10, bold: true, color: '#2d3748' },
              { text: 'Created by: ', fontSize: 9, color: '#4a5568' },
              { text: 'Tanmay Kalbande\n', fontSize: 9, color: '#2d3748', link: 'https://www.linkedin.com/in/tanmay-kalbande/', decoration: 'underline' },
          ...
          <div class="bg-[#1F1F1F] border border-[#2A2A2A] rounded-2xl shadow-2xl max-w-md w-full p-6 animate-fade-in-up">
            ...
            <div class="space-y-3 mb-6">
              ...
              <ul class="space-y-2 text-sm text-gray-400">
                ...
                <li class="flex items-start gap-2"><span class="text-green-400 shrink-0">✓</span><span>AI-Generated Disclaimer included</span></li>
